...
public class ItemConverter {
    ...
    public static ItemEntity getEntity(Item item){
        return new ItemEntity(item.getId(), item.getText(), item.getParentId(), item.getName());
    }
    ...
    public static Item translateEntity(ItemEntity entity){
        return new Item(entity.getId(), entity.getText(), entity.getParentId(), entity.getName());
    }
